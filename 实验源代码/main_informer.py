...
#parser.add_argument('--data_path', type=str, default='ETTh1-Test.csv', help='data file')
# 在这里进行了一个更改
...
parser.add_argument('--pred_len', type=int, default=24, help='prediction sequence length') #原本24
